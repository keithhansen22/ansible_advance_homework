...
* Ran into an issue with Openstack network, router, port issues. Lost environment, so had to rebuild. Ended up creating new osp-setup directory to run clean config - as something in hw config kept creating this problem. 
